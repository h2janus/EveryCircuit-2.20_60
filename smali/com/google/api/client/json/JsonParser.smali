...
.method private final parseValue(Ljava/lang/reflect/Field;Ljava/lang/reflect/Type;Ljava/util/ArrayList;Ljava/lang/Object;Lcom/google/api/client/json/CustomizeJsonParser;Z)Ljava/lang/Object;
    ...
    .line 708
    .local v37, "valueClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    :goto_0
    move-object/from16 v0, p2
    ...
    .line 707
    .end local v37    # "valueClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    :cond_2
    const/16 v37, 0x0
    ...
    .line 717
    .restart local v37    # "valueClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    :cond_3
    ...
    .line 719
    .local v31, "token":Lcom/google/api/client/json/JsonToken;
    :try_start_0
    ...
    invoke-static/range {v37 .. v37}, Lcom/google/api/client/json/JsonParser;->getCachedTypemapFieldFor(Ljava/lang/Class;)Ljava/lang/reflect/Field;

    move-result-object v36

    .line 752
    .local v36, "typemapField":Ljava/lang/reflect/Field;
    :goto_5
    const/16 v29, 0x0
    ...
    .end local v36    # "typemapField":Ljava/lang/reflect/Field;
    :cond_10
    const/4 v4, 0x0
    ...
    .line 756
    .restart local v36    # "typemapField":Ljava/lang/reflect/Field;
    :cond_12
    const/16 v27, 0x0
    ...
    .line 762
    :cond_14
    invoke-static/range {v37 .. v37}, Lcom/google/api/client/util/Data;->newMapInstance(Ljava/lang/Class;)Ljava/util/Map;
    ...
    :cond_15
    invoke-static/range {v37 .. v37}, Lcom/google/api/client/util/Types;->newInstance(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual/range {v36 .. v36}, Ljava/lang/reflect/Field;->getName()Ljava/lang/String;
    ...
    .line 791
    .local v35, "typeValueObject":Ljava/lang/Object;
    if-eqz v35, :cond_1a
    ...
    .line 794
    .local v34, "typeValue":Ljava/lang/String;
    ...
    check-cast v33, Lcom/google/api/client/json/JsonPolymorphicTypeMap;

    .line 795
    .local v33, "typeMap":Lcom/google/api/client/json/JsonPolymorphicTypeMap;
    const/4 v14, 0x0

    .line 796
    .local v14, "typeClass":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    invoke-interface/range {v33 .. v33}, Lcom/google/api/client/json/JsonPolymorphicTypeMap;->typeDefinitions()[Lcom/google/api/client/json/JsonPolymorphicTypeMap$TypeDef;
    ...
    aget-object v32, v19, v25

    .line 797
    .local v32, "typeDefinition":Lcom/google/api/client/json/JsonPolymorphicTypeMap$TypeDef;
    invoke-interface/range {v32 .. v32}, Lcom/google/api/client/json/JsonPolymorphicTypeMap$TypeDef;->key()Ljava/lang/String;
    ...
    .line 798
    invoke-interface/range {v32 .. v32}, Lcom/google/api/client/json/JsonPolymorphicTypeMap$TypeDef;->ref()Ljava/lang/Class;

    move-result-object v14

    .line 802
    .end local v32    # "typeDefinition":Lcom/google/api/client/json/JsonPolymorphicTypeMap$TypeDef;
    :cond_19
    if-eqz v14, :cond_1c
    ...
    .end local v25    # "i$":I
    .end local v28    # "len$":I
    .end local v33    # "typeMap":Lcom/google/api/client/json/JsonPolymorphicTypeMap;
    .end local v34    # "typeValue":Ljava/lang/String;
    :cond_1a
    const/4 v5, 0x0
    ...
    .restart local v32    # "typeDefinition":Lcom/google/api/client/json/JsonPolymorphicTypeMap$TypeDef;
    .restart local v33    # "typeMap":Lcom/google/api/client/json/JsonPolymorphicTypeMap;
    .restart local v34    # "typeValue":Ljava/lang/String;
    :cond_1b
    ...
    .end local v33    # "typeMap":Lcom/google/api/client/json/JsonPolymorphicTypeMap;
    .end local v34    # "typeValue":Ljava/lang/String;
    .end local v35    # "typeValueObject":Ljava/lang/Object;
    .end local v36    # "typemapField":Ljava/lang/reflect/Field;
    :pswitch_2
    if-eqz p2, :cond_1e
